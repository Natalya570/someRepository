...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Введите через пробел Покупателя, Товар и Количество:");
        while(sc.hasNext()) {
        ...
        for(Map.Entry<String, TreeMap <String, Integer>> entry : clients.entrySet()) {
            ...
            for(Map.Entry<String,Integer> product : value.entrySet()) {
                String keyProduct = product.getKey(); Integer valueProduct = product.getValue();
